...
#### VARIABLES
roL_LPC = 774   # LPC liquid density in kg/m3
roV_LPC = 1.66  # LPC vapor density in kg/m3
roL_HPC = 704   # HPC liquid density in kg/m3
roV_HPC = 16.5  # HPC vapor density in kg/m3
V_LPC = 1.49923 # LPC vapor flowrate in m3/s
V_HPC = 0.24658 # HPC vapor flowrate in m3/s
N_trays_LPC = 46    # LPC number of trays
N_trays_HPC = 33    # HPC number of trays
Q_condenser_LPC = 7083000  # condenser duty for LPC in KJ/h
Q_reboiler_LPC = 6733600   # reboiler duty for LPC in KJ/h
Q_reboiler_HPC = 7513600   # reboiler duty for HPC in KJ/h
T_dist_LPC = 333.068    # LPC distillate temperature in K
T_res_LPC = 344.407     # LPC residue temperature in K
T_dist_HPC = 409.908    # HPC distillate temperature in K
T_res_HPC = 434.124     # HPC residue temperature in K
