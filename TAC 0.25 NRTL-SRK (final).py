...
roL_HPC = 711   # HPC liquid density in kg/m3
roV_HPC = 17.0  # HPC vapor density in kg/m3
V_LPC = 1.22690 # LPC vapor flowrate in m3/s
V_HPC = 0.12569 # HPC vapor flowrate in m3/s
N_trays_LPC = 36    # LPC number of trays
N_trays_HPC = 40    # HPC number of trays
Q_condenser_LPC = 4298100  # condenser duty for LPC in KJ/h
Q_reboiler_LPC = 3822800   # reboiler duty for LPC in KJ/h
Q_condenser_HPC = 0  # condenser duty for HPC in KJ/h
Q_reboiler_HPC = 3938900   # reboiler duty for HPC in KJ/h
T_dist_LPC = 332.896    # LPC distillate temperature in K
T_res_LPC = 342.984     # LPC residue temperature in K
T_dist_HPC = 409.453    # HPC distillate temperature in K
T_res_HPC = 434.367     # HPC residue temperature in K
